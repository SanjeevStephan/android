...
import com.sanjeev.stephan.murmu.sqliteapplication.databinding.FragmentMainBinding
...
class Home: Fragment(),View.OnClickListener
{
    ...
    private fun saveRecord(view: View){
        ...
        val databaseHandler: DatabaseHandler= DatabaseHandler(view.context as Activity)
    ...
    private fun viewRecord(view: View){
        ...
        val myListAdapter = MyListAdapter(view.context as Activity,empArrayId,empArrayName,empArrayEmail)
