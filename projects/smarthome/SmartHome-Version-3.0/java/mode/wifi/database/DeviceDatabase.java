...
public class DeviceDatabase extends SQLiteOpenHelper
{
    ...
    public static final String DB_DEVICE_IMAGE = "DeviceImage";
    ...
    public void onCreate(SQLiteDatabase db)
    {
        db.execSQL("CREATE TABLE "+ DB_TABLE_NAME + " "
                ...
                + DB_DEVICE_TYPE + " INTEGER,"
                + DB_DEVICE_NAME +" TEXT,"
                + DB_DEVICE_IP + " TEXT,"
                + DB_DEVICE_IMAGE + " INTEGER,"
    ...
    public boolean insertDevice(int device_type,String device_name, String device_ip,int device_image, int relay_num, String location) {

        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(DB_DEVICE_TYPE, device_type);
        contentValues.put(DB_DEVICE_NAME, device_name);
        contentValues.put(DB_DEVICE_IP, device_ip);
        contentValues.put(DB_DEVICE_IMAGE, device_image);
    ...
    {
        /*
          This will returns the Cursor of all the Items in the Database.
         */
    ...
    {
        /*
        This method will return the Cursor(position) of an item at Database by specified by the item id.
         */
    ...
    public boolean updateDevice (Integer id,int device_type, String device_name, String device_ip,int device_image,int relay_num,String location)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(DB_DEVICE_TYPE,device_type);
